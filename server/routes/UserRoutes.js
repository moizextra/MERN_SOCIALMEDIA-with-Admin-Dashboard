...
const { registerUser,LoginUser,Logout,ForgotPassword,ResetPassword,getUserDetail,UpdatePassword,UpdateProfile, GetAllUsers, GetUser,DeleteUser,UpdateUserProfile} = require("../controllers/UserControllers");
